...
*/
for (let index = 0; index < starWarsCharacters.length; index++) {
  const element = starWarsCharacters[index].eye_color;
...
*/
for (let index = 0; index < starWarsCharacters.length; index++) {
  let element = starWarsCharacters[index];
...
for (let i = 0; i < charactersNames.length; i++) {
  const element = charactersNames[i];
  for (let index = 0; index < femaleCharacters.length; index++) {
    const element2 = femaleCharacters[index];
...
console.log("ciao sono " + discorso.name + "ed ho " + discorso.birth_year);
